// Anubhav Joshi
package com.anubhav.pep.day3;
import java.util.Scanner;
public class MatrixSum {
    public static void main(String[] args) {
        Scanner input = new Scanner(System.in);
        System.out.println("Enter the 1st size of 1st 2D array: ");
        ...
        int[][] arrSum = sum(arr1, arr2, size1);
    ...
    static int[][] sum(int[][] a1, int[][] a2, int s){
        int[][] arrSum  = new int[s][s];
        for (int i = 0; i < s; i++) {
            for (int j = 0; j < s; j++) {
